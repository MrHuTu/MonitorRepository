...
public class UserController {
	...
	@ApiOperation(value = "账号唯一校验--zemin.deng", httpMethod = "GET", response = Result.class, notes = "验证账号是否唯一")
	...
	*//**
	...
	@ApiOperation(value = "邮箱唯一校验--zemin.deng", httpMethod = "GET", response = Result.class, notes = "验证邮箱是否唯一")
	...
	*//**
	...
	@ApiOperation(value = "手机号码唯一校验--zemin.deng", httpMethod = "GET", response = Result.class, notes = "验证手机号码是否唯一")
...
/*	*//**
	 ...
	 *//*
	@PostMapping
	@ApiOperation(value = "添加用户--zemin.deng", httpMethod = "POST", response = Result.class, notes = "添加一个用户")
