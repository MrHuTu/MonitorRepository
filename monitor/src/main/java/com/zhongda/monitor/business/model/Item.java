...
public String toString() {
	return "Item [project_id=" + project_id + ", project_name=" + project_name
			+ ", real_name=" + real_name + ", project_begin_time="
			+ project_begin_time + ", project_end_time=" + project_end_time
			+ ", project_type=" + project_type + ", project_address="
			+ project_address + ", project_description=" + project_description
